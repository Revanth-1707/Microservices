...
public class Routes {
	...
	public RouterFunction<ServerResponse> productServiceSwaggerRoute(){
		return GatewayRouterFunctions.route("product_service_swagger")
	            ...
	            .filter(FilterFunctions.rewritePath("/aggregate/product-service/v3/api-docs", "/api-docs"))
				.build();
	}
	...
	public RouterFunction<ServerResponse> orderServiceSwaggerRoute(){
		return GatewayRouterFunctions.route("order_service_swagger")
				...
				.filter(FilterFunctions.rewritePath("/aggregate/order-service/v3/api-docs", "/api-docs"))
				.build();
	}
	...
	public RouterFunction<ServerResponse> inventoryServiceSwaggerRoute(){
		return GatewayRouterFunctions.route("inventory_service_swagger")
				...
				.filter(FilterFunctions.rewritePath("/aggregate/inventory-service/v3/api-docs", "/api-docs"))
				.build();
	}
	...
	public RouterFunction<ServerResponse> fallbackRoute(){
		return GatewayRouterFunctions.route("fallbackRoute")
				.GET("/fallbackRoute", request -> ServerResponse.status(HttpStatus.SERVICE_UNAVAILABLE)
						.body("Service Unvailable, please try again later"))
				.build();
	}
}
